    ...
    <div className="min-h-screen bg-ink-900 text-paper-100">
      ...
      <header className="flex items-center justify-between gap-2.5 px-5 pt-5 md:hidden">
        <div className="flex items-center gap-2">
          <span className="flex h-8 w-8 items-center justify-center rounded-full bg-amber/15 font-display text-sm text-amber-light">V</span>
          <div className="leading-tight">
            <p className="font-display text-base text-paper-100">VocaNight</p>
            <p className="-mt-0.5 font-sans text-[10px] uppercase tracking-wide text-paper-400">Học từ vựng mỗi đêm</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <SyncIndicator />
